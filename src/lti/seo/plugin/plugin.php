...
class Defaults {
	...
	public function __construct() {
		$this->values = array(
			...
			new def( 'jsonld_type_wp_userid', 'Text' ),
			new def( 'jsonld_type_logo_url', 'Url' ),
			new def( 'jsonld_type_logo_id', 'Text' ),
			new def( 'jsonld_type_alternate_name', 'Text' ),
			new def( 'jsonld_type_website_url', 'Url' ),
			new def( 'jsonld_page', 'Checkbox' ),
			new def( 'jsonld_post', 'Checkbox' ),
			new def( 'jsonld_post_type', 'Radio', array(
				'default' => 'Article',
				'choice'  => array( 'Article', 'BlogPosting', 'NewsArticle', 'ScholarlyArticle', 'TechArticle' )
			) ),
			new def( 'jsonld_author', 'Checkbox' ),
